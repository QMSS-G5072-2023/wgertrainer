...
if __name__ == "__main__":
    ...
    # User input for filtering exercises by equipment
    try:
    ...
    # User input for finding the best exercise based on equipment and muscle
    try:
        ...
        print("Invalid input. Please enter a valid equipment and muscle (integer).")
